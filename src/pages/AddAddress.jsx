      ...
      <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
        <div className='flex-1 max-w-md'>
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-5'>
                ...
                <InputField type='email' handleChange={handleChange} address={address} name='email' placeholder='Email'/>
                ...
                <InputField type='text' handleChange={handleChange} address={address} name='phone' placeholder='Phone number'/>
