...
const Cart = () => {
    ...
    const getCart = () => {
        ...
        for (const key in cartItems) {
            ...
            if (product) {
                ...
                console.warn(`Product with ID ${key} not found in the product list.`)
            }
    ...
    const getUserAddress = async () => {
        try {
            ...
            if (data.success) {
                ...
                toast.error(data.message, 'address')
            }
        } catch (error) {
            toast.error(error.message, 'address')
        }
    }
    ...
    return products.length > 0 && cartItems ? (
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        ...
                        <div className='flex flex-row mx-auto'>
                            ...
                            <img onClick={() => removeFromCart(product._id)} src={assets.remove_icon} alt="remove" className="inline-block w-6 h-6 ml-3 block md:hidden" />
                        </div>
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate('/add-address')} className="text-primary text-center cursor-pointer p-2 hover:bg-primary-dull hover:text-gray-100 ">
                                    Add address
                                </p>
                            </div>
                        )}
        ...
        <h1 className="h-100 text-5xl flex flex-col items-center justify-center ">There is no <span className="inline-block font-semibold text-primary">Product</span> in the cart yet</h1>
    </div>
}
